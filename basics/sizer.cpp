...
int main()
{
    ...
    std::cout<<"The size of long integer:\t";
    std::cout<<sizeof(long)<<"bytes\n";
    std::cout<<"The size of characters:\t";
    std::cout<<sizeof(char)<<"bytes\n";
    std::cout<<"The size of boolean\t";
    std::cout<<sizeof(bool)<<"bytes\n";
    std::cout<<"The size of float\t";
    std::cout<<sizeof(float)<<"bytes\n";
    std::cout<<"The size of double float\t";
    std::cout<<sizeof(double)<<"bytes\n";
    std::cout<<"The size of long long int\t";
